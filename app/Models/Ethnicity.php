...
class Ethnicity extends Model
{
    ...
    /**
     * Get the account associated with the ethnicity.
     */
    ...
    /**
     * Get the contacts associated with the ethnicity.
     */
     ...
     * Ethnicity entries have a default label that can be translated.
