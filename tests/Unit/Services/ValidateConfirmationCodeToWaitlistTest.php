...
class ValidateConfirmationCodeToWaitlistTest extends TestCase
{
    ...
    #[Test]
    public function it_validates_and_confirms_a_waitlist_entry(): void
    {
    ...
    #[Test]
    public function it_throws_an_exception_when_code_is_invalid(): void
    {
    ...
    #[Test]
    public function it_throws_an_exception_when_already_confirmed(): void
    {
        UserWaitlist::factory()->create([
