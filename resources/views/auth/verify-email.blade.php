<x-guest-layout>
  ...
  <div class="mt-6 mb-12 w-full overflow-hidden bg-white px-6 py-6 shadow-md sm:max-w-md sm:rounded-lg dark:bg-gray-900">
    ...
    <div class="mb-8 flex items-center gap-x-2 justify-center">
    ...
    <div class="mt-4 flex items-center justify-between">
      ...
      <form method="POST" action="{{ route('logout') }}">
        ...
        <button type="submit" class="rounded-md cursor-pointer text-sm text-gray-600 underline hover:text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden dark:text-gray-400 dark:hover:text-gray-100 dark:focus:ring-offset-gray-800">
          {{ __('Log out') }}
        </button>
      </form>
    </div>
