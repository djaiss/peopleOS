<div class="flex h-[calc(100vh-48px)] flex-col overflow-hidden bg-white">
  ...
  <nav class="border-b border-gray-200">
    <div class="flex flex-col">
      ...
      <a href="{{ route('persons.notes.index') }}" class="flex items-center gap-3 border-l-2 border-blue-500 bg-blue-50 px-4 py-3">
        <x-lucide-book-open class="h-4 w-4 text-blue-500" />
        <span class="text-sm font-medium text-blue-700">Notes</span>
      </a>
