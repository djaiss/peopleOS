      ...
      <div class="divide-y divide-gray-200">
        @forelse ($month['reminders'] as $reminder)
          <div class="flex items-center justify-between p-4">
            ...
            <div class="flex items-center gap-2">
              <form x-target="reminder-{{ $reminder['id'] }} tasks-list" id="reminder-{{ $reminder['id'] }}" action="{{ route('person.reminder.test', ['slug' => $person->slug, 'specialDate' => $reminder['id']]) }}" method="POST">
                @csrf
