          ...
          <div class="space-y-6">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-4">
              <div class="flex items-center gap-3">
                <x-image class="h-12 w-12 rounded-full object-cover p-[0.1875rem] shadow-sm ring-1 ring-slate-900/10" width="48" height="48" src="{{ auth()->user()->getAvatar(64) }}" alt="{{ auth()->user()->name }}" />
                <div>
              ...
              <div class="divide-y divide-gray-200">
                @forelse ($persons as $person)
                  <div class="flex items-center justify-between px-4 py-2 hover:bg-gray-50">
                    <div class="flex items-center gap-2">
                      <x-image class="h-7 w-7 rounded-full object-cover p-[0.1875rem] shadow-sm ring-1 ring-slate-900/10" width="28" height="28" src="{{ $person['avatar']['40'] }}" srcset="{{ $person['avatar']['40'] }}, {{ $person['avatar']['80'] }} 2x" alt="{{ $person['name'] }}" />
                      <div>
