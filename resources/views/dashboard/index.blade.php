            ...
            <div class="p-4">
              <div class="flex items-center gap-x-5">
                <div class="flex flex-col text-center">
                  <p class="text-gray-500 text-xs">May</p>
                  <p class="text-gray-500 text-4xl">15</p>
                </div>

                <div class="min-w-0 flex-1">
                  <p class="text-sm text-gray-500">Birthday on May 15</p>
                  <a href="#" class="font-medium text-gray-900 hover:underline">John Doe</a>
                </div>
                <img class="h-10 w-10 rounded-full object-cover p-[0.1875rem] shadow-sm ring-1 ring-slate-900/10" src="https://ui-avatars.com/api/?name=John+Doe&color=333333&background=EBF4FF&size=40" alt="John Doe" />
              </div>
            </div>

            <div class="p-4">
              <div class="flex items-center gap-3">
                <img class="h-10 w-10 rounded-full object-cover p-[0.1875rem] shadow-sm ring-1 ring-slate-900/10" src="https://ui-avatars.com/api/?name=Jane+Smith&color=333333&background=EBF4FF&size=40" alt="Jane Smith" />
                <div class="min-w-0 flex-1">
                  <a href="#" class="font-medium text-gray-900 hover:underline">Jane Smith</a>
                  <p class="text-sm text-gray-500">Anniversary on June 1</p>
                </div>
              </div>
            </div>
          </div>
