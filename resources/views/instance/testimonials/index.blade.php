  ...
  <div class="py-12">
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-12 gap-6">
        <!-- menu -->
        @include(
          'instance.testimonials.partials.sidebar',
          [
        ...
        <div class="col-span-9">
          <div id="testimonials-list" class="rounded-lg border border-b-0 border-gray-200 bg-white shadow-sm">
            ...
            @forelse ($testimonials as $testimonial)
              <div id="testimonial-{{ $testimonial['id'] }}" x-data="{ open: false }">
                <div @click="open = !open" class="group flex cursor-pointer items-center justify-between border-b border-gray-200 p-4 text-sm first:rounded-t-lg last:border-b-0 hover:bg-blue-50" :class="{'border-b-0 rounded-b-lg': !open && $loop->last}">
