...
<div class="col-span-3">
  <div class="rounded-lg border border-gray-200 bg-white shadow-sm">
    ...
    <nav class="p-2">
      <a href="{{ route('instance.testimonial.index') }}" class="group flex items-center gap-x-3 rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-50 {{ request()->routeIs('instance.testimonial.index') ? 'bg-blue-50 text-blue-700' : 'text-gray-700' }}">
      ...
      <a href="{{ route('instance.testimonial.approved') }}" class="group flex items-center gap-x-3 rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-50 {{ request()->routeIs('instance.testimonial.approved') ? 'bg-blue-50 text-blue-700' : 'text-gray-700' }}">
      ...
      <a href="{{ route('instance.testimonial.rejected') }}" class="group flex items-center gap-x-3 rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-50 {{ request()->routeIs('instance.testimonial.rejected') ? 'bg-blue-50 text-blue-700' : 'text-gray-700' }}">
      ...
      <a href="{{ route('instance.testimonial.all') }}" class="group flex items-center gap-x-3 rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-50 {{ request()->routeIs('instance.testimonial.all') ? 'bg-blue-50 text-blue-700' : 'text-gray-700' }}">
