<div x-data="{ addMode: false }">
  <div class="relative mb-8 rounded-lg border border-gray-200 bg-gray-50 p-3 dark:border-gray-700 dark:bg-gray-900">
    ...
    <div x-show="addMode" x-cloak>
      ...
      <div class="relative mb-4">
        ...
        <x-text-input @keyup.escape="addMode = false" class="mt-1 block w-full" id="job_title" name="job_title" type="text" />

        <x-input-error class="mt-2" :messages="$errors->get('job_title')" />
      </div>

      <div class="flex justify-between">
        <x-button.secondary x-on:click="addMode = false" class="mr-2">
          {{ __('Cancel') }}
        </x-button.secondary>
  ...
  <div x-on:click="addMode = true" x-show="! addMode" class="group mb-8 flex cursor-pointer items-center rounded-lg border border-gray-200 bg-gray-50 p-3 hover:border-gray-400 dark:border-gray-700 dark:bg-gray-900">
