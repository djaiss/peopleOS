<div class="flex h-[calc(100vh-48px)] flex-col overflow-hidden bg-white">
  ...
  <div class="shrink-0 border-b border-gray-200 p-3">
    <div class="relative">
      ...
      <x-text-input wire:model.live.debounce.300ms="search" type="text" placeholder="{{ __('Search someone') }}" class="w-full border border-gray-300 bg-gray-100 py-1 pr-3 pl-8 text-sm focus:bg-white" />
    </div>
  </div>
