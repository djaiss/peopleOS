...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <span id="example-requests-GETapi-persons--person_id--notes">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request GET \
    --get "https://peopleos.test/api/persons/quam/notes" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
          ...
          <div class="javascript-example">
            <pre><code class="language-javascript">const url = new URL(
    "https://peopleos.test/api/persons/quam/notes"
);
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/quam/notes';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-GETapi-persons--person_id--notes" data-method="GET" data-path="api/persons/{person_id}/notes" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('GETapi-persons--person_id--notes', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="GETapi-persons--person_id--notes" value="quam" data-component="url" />
            <br />
            <p>
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <span id="example-requests-GETapi-persons--person_id--notes--id-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request GET \
    --get "https://peopleos.test/api/persons/saepe/notes/esse" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
          ...
          <div class="javascript-example">
            <pre><code class="language-javascript">const url = new URL(
    "https://peopleos.test/api/persons/saepe/notes/esse"
);
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/saepe/notes/esse';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-GETapi-persons--person_id--notes--id-" data-method="GET" data-path="api/persons/{person_id}/notes/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('GETapi-persons--person_id--notes--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="GETapi-persons--person_id--notes--id-" value="saepe" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>saepe</code>
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="GETapi-persons--person_id--notes--id-" value="esse" data-component="url" />
            <br />
            <p>
        ...
        <span id="example-requests-PUTapi-persons--person_id--notes--id-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request PUT \
    "https://peopleos.test/api/persons/aut/notes/esse" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"content\": \"Ross is a good friend of mine.\"
...
fetch(url, {
    ...
    body: JSON.stringify(body),
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/aut/notes/esse';
$response = $client-&gt;put(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-PUTapi-persons--person_id--notes--id-" data-method="PUT" data-path="api/persons/{person_id}/notes/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('PUTapi-persons--person_id--notes--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="PUTapi-persons--person_id--notes--id-" value="esse" data-component="url" />
            <br />
            <p>
              The ID of the note. Example:
              <code>esse</code>
        ...
        <span id="example-requests-DELETEapi-persons--person_id--notes--id-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request DELETE \
    "https://peopleos.test/api/persons/est/notes/sunt" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/est/notes/sunt';
$response = $client-&gt;delete(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-DELETEapi-persons--person_id--notes--id-" data-method="DELETE" data-path="api/persons/{person_id}/notes/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('DELETEapi-persons--person_id--notes--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="DELETEapi-persons--person_id--notes--id-" value="est" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>est</code>
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="DELETEapi-persons--person_id--notes--id-" value="sunt" data-component="url" />
            <br />
            <p>
              The ID of the note. Example:
              <code>sunt</code>
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <span id="example-requests-GETapi-persons--id-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request GET \
    --get "https://peopleos.test/api/persons/velit" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
          ...
          <div class="javascript-example">
            <pre><code class="language-javascript">const url = new URL(
    "https://peopleos.test/api/persons/velit"
);
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/velit';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-GETapi-persons--id-" data-method="GET" data-path="api/persons/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('GETapi-persons--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="GETapi-persons--id-" value="velit" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>velit</code>
    ...
    \"nickname\": \"Mike\",
    \"maiden_name\": \"Johnson\",
    \"patronymic_name\": \"gqmbagyhvuehyudla\",
    \"tribal_name\": \"qvdbl\",
    \"prefix\": \"Mr.\",
    \"suffix\": \"Jr.\",
    \"can_be_deleted\": true,
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-PUTapi-persons--id-" data-method="PUT" data-path="api/persons/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('PUTapi-persons--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="PUTapi-persons--id-" value="ad" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>ad</code>
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <i>optional</i>
            &nbsp;
            <input type="text" style="display: none" name="patronymic_name" data-endpoint="PUTapi-persons--id-" value="gqmbagyhvuehyudla" data-component="body" />
            <br />
            <p>
              Must not be greater than 255 characters. Example:
              <code>gqmbagyhvuehyudla</code>
            </p>
          </div>
          <div style="padding-left: 28px; clear: unset">
            ...
            <i>optional</i>
            &nbsp;
            <input type="text" style="display: none" name="tribal_name" data-endpoint="PUTapi-persons--id-" value="qvdbl" data-component="body" />
            <br />
            <p>
              Must not be greater than 255 characters. Example:
              <code>qvdbl</code>
        ...
        <span id="example-requests-DELETEapi-persons--id-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request DELETE \
    "https://peopleos.test/api/persons/quas" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/quas';
$response = $client-&gt;delete(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-DELETEapi-persons--id-" data-method="DELETE" data-path="api/persons/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('DELETEapi-persons--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="DELETEapi-persons--id-" value="quas" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>quas</code>
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <span id="example-requests-GETapi-persons--person_id--work-history--entry-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request GET \
    --get "https://peopleos.test/api/persons/est/work-history/temporibus" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
          ...
          <div class="javascript-example">
            <pre><code class="language-javascript">const url = new URL(
    "https://peopleos.test/api/persons/est/work-history/temporibus"
);
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/est/work-history/temporibus';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-GETapi-persons--person_id--work-history--entry-" data-method="GET" data-path="api/persons/{person_id}/work-history/{entry}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('GETapi-persons--person_id--work-history--entry-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="GETapi-persons--person_id--work-history--entry-" value="est" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>est</code>
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="entry" data-endpoint="GETapi-persons--person_id--work-history--entry-" value="temporibus" data-component="url" />
            <br />
            <p>
              Example:
        ...
        <span id="example-requests-PUTapi-persons--person_id--work-history--entry-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request PUT \
    "https://peopleos.test/api/persons/ut/work-history/harum" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"company_name\": \"Google\",
...
fetch(url, {
    ...
    body: JSON.stringify(body),
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/ut/work-history/harum';
$response = $client-&gt;put(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-PUTapi-persons--person_id--work-history--entry-" data-method="PUT" data-path="api/persons/{person_id}/work-history/{entry}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('PUTapi-persons--person_id--work-history--entry-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="PUTapi-persons--person_id--work-history--entry-" value="ut" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>ut</code>
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="entry" data-endpoint="PUTapi-persons--person_id--work-history--entry-" value="harum" data-component="url" />
            <br />
            <p>
              Example:
              <code>harum</code>
        ...
        <span id="example-requests-DELETEapi-persons--person_id--work-history--entry-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request DELETE \
    "https://peopleos.test/api/persons/ducimus/work-history/modi" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/ducimus/work-history/modi';
$response = $client-&gt;delete(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-DELETEapi-persons--person_id--work-history--entry-" data-method="DELETE" data-path="api/persons/{person_id}/work-history/{entry}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('DELETEapi-persons--person_id--work-history--entry-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="DELETEapi-persons--person_id--work-history--entry-" value="ducimus" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>ducimus</code>
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="entry" data-endpoint="DELETEapi-persons--person_id--work-history--entry-" value="modi" data-component="url" />
            <br />
            <p>
              Example:
              <code>modi</code>
