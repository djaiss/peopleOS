...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <span id="example-requests-GETapi-persons--person_id--notes--id-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request GET \
    --get "https://peopleos.test/api/persons/ea/notes/asperiores" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
          ...
          <div class="javascript-example">
            <pre><code class="language-javascript">const url = new URL(
    "https://peopleos.test/api/persons/ea/notes/asperiores"
);
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/ea/notes/asperiores';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-GETapi-persons--person_id--notes--id-" data-method="GET" data-path="api/persons/{person_id}/notes/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('GETapi-persons--person_id--notes--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="GETapi-persons--person_id--notes--id-" value="ea" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>ea</code>
        ...
        <span id="example-requests-PUTapi-persons--person_id--notes--id-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request PUT \
    "https://peopleos.test/api/persons/et/notes/excepturi" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"content\": \"Ross is a good friend of mine.\"
...
fetch(url, {
    ...
    body: JSON.stringify(body),
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/et/notes/excepturi';
$response = $client-&gt;put(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-PUTapi-persons--person_id--notes--id-" data-method="PUT" data-path="api/persons/{person_id}/notes/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('PUTapi-persons--person_id--notes--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="PUTapi-persons--person_id--notes--id-" value="et" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>et</code>
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="PUTapi-persons--person_id--notes--id-" value="excepturi" data-component="url" />
            <br />
            <p>
              The ID of the note. Example:
              <code>excepturi</code>
        ...
        <span id="example-requests-DELETEapi-persons--person_id--notes--id-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request DELETE \
    "https://peopleos.test/api/persons/maxime/notes/expedita" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/maxime/notes/expedita';
$response = $client-&gt;delete(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-DELETEapi-persons--person_id--notes--id-" data-method="DELETE" data-path="api/persons/{person_id}/notes/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('DELETEapi-persons--person_id--notes--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="DELETEapi-persons--person_id--notes--id-" value="maxime" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>maxime</code>
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="DELETEapi-persons--person_id--notes--id-" value="expedita" data-component="url" />
            <br />
            <p>
              The ID of the note. Example:
              <code>expedita</code>
...
You can check the Dev Tools console for debugging information.</code></pre>
    ...
    \"nickname\": \"Mike\",
    \"maiden_name\": \"Johnson\",
    \"patronymic_name\": \"ubeekugfkv\",
    \"tribal_name\": \"yvrievntahy\",
    \"prefix\": \"Mr.\",
    \"suffix\": \"Jr.\",
    \"can_be_deleted\": true
}"
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-PUTapi-persons--id-" data-method="PUT" data-path="api/persons/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('PUTapi-persons--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <i>optional</i>
            &nbsp;
            <input type="text" style="display: none" name="patronymic_name" data-endpoint="PUTapi-persons--id-" value="ubeekugfkv" data-component="body" />
            <br />
            <p>
              Must not be greater than 255 characters. Example:
              <code>ubeekugfkv</code>
            </p>
          </div>
          <div style="padding-left: 28px; clear: unset">
            ...
            <i>optional</i>
            &nbsp;
            <input type="text" style="display: none" name="tribal_name" data-endpoint="PUTapi-persons--id-" value="yvrievntahy" data-component="body" />
            <br />
            <p>
              Must not be greater than 255 characters. Example:
              <code>yvrievntahy</code>
            </p>
          </div>
          <div style="padding-left: 28px; clear: unset">
            <b style="line-height: 2"><code>prefix</code></b>
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <span id="example-requests-PUTapi-teams--id-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request PUT \
    "https://peopleos.test/api/teams/officiis" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"Web developers\"
...
fetch(url, {
    ...
    body: JSON.stringify(body),
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/teams/officiis';
$response = $client-&gt;put(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-PUTapi-teams--id-" data-method="PUT" data-path="api/teams/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('PUTapi-teams--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="PUTapi-teams--id-" value="officiis" data-component="url" />
            <br />
            <p>
