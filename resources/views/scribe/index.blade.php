...
<aside>
    <strong>Base URL</strong>: <code>https://peopleos.test</code>
</aside>
...
<p>If you change your email, the system will send a new verification email to
verify the new email address.</p>
<p>Please note that your password can not be changed through the API at
the moment.</p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="first_name"                data-endpoint="PUTapi-me"
               value="Dwight"
               data-component="body">
    <br>
<p>The first name of the user. Max 255 characters. Example: <code>Dwight</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>last_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="last_name"                data-endpoint="PUTapi-me"
               value="Schrute"
               data-component="body">
    <br>
<p>The last name of the user. Max 255 characters. Example: <code>Schrute</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="dwight.schrute@dundermifflin.com"
               data-component="body">
    <br>
<p>The email of the user. Max 255 characters. Example: <code>dwight.schrute@dundermifflin.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>nickname</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="nickname"                data-endpoint="PUTapi-me"
               value="Dwight"
               data-component="body">
    <br>
<p>The nickname of the user. Max 255 characters. Example: <code>Dwight</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>born_at</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="born_at"                data-endpoint="PUTapi-me"
               value="1985-03-15"
               data-component="body">
    <br>
<p>The birth date of the user. Format: YYYY-MM-DD. Example: <code>1985-03-15</code></p>
        </div>
        </form>
...
<span id="execution-results-PUTapi-administration-prune" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-administration-prune"></span>:
    </blockquote>
...
<form id="form-PUTapi-administration-prune" data-method="PUT"
      data-path="api/administration/prune"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-administration-prune', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-administration-prune"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-administration-prune"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>Sends a new invitation to a user who has not yet accepted the invitation.
Only administrators and HR representatives can send a new invitation.</p>
<p>The invitation will be valid for 3 days. After 3 days, the user will need
to request a new invitation.</p>
...
<span id="execution-results-PUTapi-administration-users--user_id--invite" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-administration-users--user_id--invite"></span>:
    </blockquote>
...
<form id="form-PUTapi-administration-users--user_id--invite" data-method="PUT"
      data-path="api/administration/users/{user_id}/invite"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-administration-users--user_id--invite', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-administration-users--user_id--invite"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-administration-users--user_id--invite"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               step="any"               name="user_id"                data-endpoint="PUTapi-administration-users--user_id--invite"
               value="1"
               data-component="url">
    <br>
...
<span id="execution-results-GETapi-administration-genders" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-administration-genders"></span>:
    </blockquote>
...
<form id="form-GETapi-administration-genders" data-method="GET"
      data-path="api/administration/genders"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-administration-genders', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-administration-genders"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-administration-genders"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>A gender categorizes the gender identity of a person.
...
position.
A person can have one gender, or not gender at all.</p>
...
<span id="execution-results-POSTapi-administration-genders" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-administration-genders"></span>:
    </blockquote>
...
<form id="form-POSTapi-administration-genders" data-method="POST"
      data-path="api/administration/genders"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-administration-genders', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-administration-genders"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-administration-genders"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-administration-genders"
               value="Male"
               data-component="body">
    <br>
<p>The name of the gender. Max 255 characters. Example: <code>Male</code></p>
        </div>
        </form>
...
<span id="execution-results-PUTapi-administration-genders--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-administration-genders--id-"></span>:
    </blockquote>
...
<form id="form-PUTapi-administration-genders--id-" data-method="PUT"
      data-path="api/administration/genders/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-administration-genders--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-administration-genders--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-administration-genders--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PUTapi-administration-genders--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the gender. Example: <code>1</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="gender"                data-endpoint="PUTapi-administration-genders--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the gender. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-administration-genders--id-"
               value="Female"
               data-component="body">
    <br>
<p>The name of the gender. Max 255 characters. Example: <code>Female</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>position</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="position"                data-endpoint="PUTapi-administration-genders--id-"
               value="2"
               data-component="body">
    <br>
<p>The position of the gender in the list. Example: <code>2</code></p>
        </div>
        </form>
...
<span id="execution-results-DELETEapi-administration-genders--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-administration-genders--id-"></span>:
    </blockquote>
...
<form id="form-DELETEapi-administration-genders--id-" data-method="DELETE"
      data-path="api/administration/genders/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-administration-genders--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-administration-genders--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-administration-genders--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="DELETEapi-administration-genders--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the gender. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="gender"                data-endpoint="DELETEapi-administration-genders--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the gender. Example: <code>1</code></p>
...
<span id="execution-results-GETapi-administration-marital-statuses" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-administration-marital-statuses"></span>:
    </blockquote>
...
<form id="form-GETapi-administration-marital-statuses" data-method="GET"
      data-path="api/administration/marital-statuses"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-administration-marital-statuses', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-administration-marital-statuses"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-administration-marital-statuses"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>A marital status categorizes the marital status of a person.
...
position.
A person can have one marital status, or not marital status at all.</p>
...
<span id="execution-results-POSTapi-administration-marital-statuses" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-administration-marital-statuses"></span>:
    </blockquote>
...
<form id="form-POSTapi-administration-marital-statuses" data-method="POST"
      data-path="api/administration/marital-statuses"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-administration-marital-statuses', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-administration-marital-statuses"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-administration-marital-statuses"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-administration-marital-statuses"
               value="Married"
               data-component="body">
    <br>
<p>The name of the marital status. Max 255 characters. Example: <code>Married</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "https://peopleos.test/api/administration/marital-statuses/4" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"Married\",
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/administration/marital-statuses/4';
$response = $client-&gt;put(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-PUTapi-administration-marital-statuses--maritalStatus_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-administration-marital-statuses--maritalStatus_id-"></span>:
    </blockquote>
...
<form id="form-PUTapi-administration-marital-statuses--maritalStatus_id-" data-method="PUT"
      data-path="api/administration/marital-statuses/{maritalStatus_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-administration-marital-statuses--maritalStatus_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-administration-marital-statuses--maritalStatus_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-administration-marital-statuses--maritalStatus_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="maritalStatus_id"                data-endpoint="PUTapi-administration-marital-statuses--maritalStatus_id-"
               value="4"
               data-component="url">
    <br>
<p>The ID of the maritalStatus. Example: <code>4</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="marital_status"                data-endpoint="PUTapi-administration-marital-statuses--maritalStatus_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the marital status. Example: <code>1</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-administration-marital-statuses--maritalStatus_id-"
               value="Married"
               data-component="body">
    <br>
<p>The name of the marital status. Max 255 characters. Example: <code>Married</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="position"                data-endpoint="PUTapi-administration-marital-statuses--maritalStatus_id-"
               value="2"
               data-component="body">
    <br>
<p>The position of the marital status in the list. Example: <code>2</code></p>
        </div>
        </form>
...
<span id="execution-results-DELETEapi-administration-marital-statuses--maritalStatus_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-administration-marital-statuses--maritalStatus_id-"></span>:
    </blockquote>
...
<form id="form-DELETEapi-administration-marital-statuses--maritalStatus_id-" data-method="DELETE"
      data-path="api/administration/marital-statuses/{maritalStatus_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-administration-marital-statuses--maritalStatus_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-administration-marital-statuses--maritalStatus_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-administration-marital-statuses--maritalStatus_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="maritalStatus_id"                data-endpoint="DELETEapi-administration-marital-statuses--maritalStatus_id-"
               value="15"
               data-component="url">
    <br>
<p>The ID of the maritalStatus. Example: <code>15</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>marital_status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="marital_status"                data-endpoint="DELETEapi-administration-marital-statuses--maritalStatus_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the marital status. Example: <code>1</code></p>
...
<p>This API call returns a paginated collection of notes that contains
15 items per page.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://peopleos.test/api/persons/eius/notes" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://peopleos.test/api/persons/eius/notes"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/eius/notes';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-GETapi-persons--person_id--notes" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-persons--person_id--notes"></span>:
    </blockquote>
...
<form id="form-GETapi-persons--person_id--notes" data-method="GET"
      data-path="api/persons/{person_id}/notes"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-persons--person_id--notes', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-persons--person_id--notes"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-persons--person_id--notes"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person_id"                data-endpoint="GETapi-persons--person_id--notes"
               value="eius"
               data-component="url">
    <br>
<p>The ID of the person. Example: <code>eius</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person"                data-endpoint="GETapi-persons--person_id--notes"
               value="1"
               data-component="url">
    <br>
...
<span id="execution-results-POSTapi-persons--person--notes" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-persons--person--notes"></span>:
    </blockquote>
...
<form id="form-POSTapi-persons--person--notes" data-method="POST"
      data-path="api/persons/{person}/notes"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-persons--person--notes', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-persons--person--notes"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-persons--person--notes"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person"                data-endpoint="POSTapi-persons--person--notes"
               value="1"
               data-component="url">
    <br>
<p>The id of the person. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="content"                data-endpoint="POSTapi-persons--person--notes"
               value="Ross is a good friend of mine."
               data-component="body">
    <br>
<p>The content of the note. Max 255 characters. Example: <code>Ross is a good friend of mine.</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://peopleos.test/api/persons/quod/notes/eum" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://peopleos.test/api/persons/quod/notes/eum"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/quod/notes/eum';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-GETapi-persons--person_id--notes--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-persons--person_id--notes--id-"></span>:
    </blockquote>
...
<form id="form-GETapi-persons--person_id--notes--id-" data-method="GET"
      data-path="api/persons/{person_id}/notes/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-persons--person_id--notes--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-persons--person_id--notes--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-persons--person_id--notes--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person_id"                data-endpoint="GETapi-persons--person_id--notes--id-"
               value="quod"
               data-component="url">
    <br>
<p>The ID of the person. Example: <code>quod</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-persons--person_id--notes--id-"
               value="eum"
               data-component="url">
    <br>
<p>The ID of the note. Example: <code>eum</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>person</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person"                data-endpoint="GETapi-persons--person_id--notes--id-"
               value="1"
               data-component="url">
    <br>
<p>The id of the person. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="note"                data-endpoint="GETapi-persons--person_id--notes--id-"
               value="1"
               data-component="url">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "https://peopleos.test/api/persons/saepe/notes/tempora" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"content\": \"Ross is a good friend of mine.\"
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/saepe/notes/tempora';
$response = $client-&gt;put(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-PUTapi-persons--person_id--notes--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-persons--person_id--notes--id-"></span>:
    </blockquote>
...
<form id="form-PUTapi-persons--person_id--notes--id-" data-method="PUT"
      data-path="api/persons/{person_id}/notes/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-persons--person_id--notes--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-persons--person_id--notes--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-persons--person_id--notes--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person_id"                data-endpoint="PUTapi-persons--person_id--notes--id-"
               value="saepe"
               data-component="url">
    <br>
<p>The ID of the person. Example: <code>saepe</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-persons--person_id--notes--id-"
               value="tempora"
               data-component="url">
    <br>
<p>The ID of the note. Example: <code>tempora</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>person</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person"                data-endpoint="PUTapi-persons--person_id--notes--id-"
               value="1"
               data-component="url">
    <br>
<p>The id of the person. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="content"                data-endpoint="PUTapi-persons--person_id--notes--id-"
               value="Ross is a good friend of mine."
               data-component="body">
    <br>
<p>The content of the note. Max 255 characters. Example: <code>Ross is a good friend of mine.</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request DELETE \
    "https://peopleos.test/api/persons/dolorem/notes/excepturi" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/dolorem/notes/excepturi';
$response = $client-&gt;delete(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-DELETEapi-persons--person_id--notes--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-persons--person_id--notes--id-"></span>:
    </blockquote>
...
<form id="form-DELETEapi-persons--person_id--notes--id-" data-method="DELETE"
      data-path="api/persons/{person_id}/notes/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-persons--person_id--notes--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-persons--person_id--notes--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-persons--person_id--notes--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person_id"                data-endpoint="DELETEapi-persons--person_id--notes--id-"
               value="dolorem"
               data-component="url">
    <br>
<p>The ID of the person. Example: <code>dolorem</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-persons--person_id--notes--id-"
               value="excepturi"
               data-component="url">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person"                data-endpoint="DELETEapi-persons--person_id--notes--id-"
               value="1"
               data-component="url">
    <br>
<p>The id of the person. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="note"                data-endpoint="DELETEapi-persons--person_id--notes--id-"
               value="1"
               data-component="url">
    <br>
<p>The id of the note. Example: <code>1</code></p>
...
<p>This API call returns a paginated collection of persons that contains
15 items per page.</p>
...
<span id="execution-results-GETapi-persons" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-persons"></span>:
    </blockquote>
...
<form id="form-GETapi-persons" data-method="GET"
      data-path="api/persons"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-persons', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-persons"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-persons"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>Once created, the person will be returned in the response, as well as
...
<span id="execution-results-POSTapi-persons" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-persons"></span>:
    </blockquote>
...
<form id="form-POSTapi-persons" data-method="POST"
      data-path="api/persons"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-persons', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-persons"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-persons"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="gender_id"                data-endpoint="POSTapi-persons"
               value="1"
               data-component="body">
    <br>
<p>The gender object associated with the person. This object must be a valid Gender object. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>first_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="first_name"                data-endpoint="POSTapi-persons"
               value="Ross"
               data-component="body">
    <br>
<p>The first name of the person. Max 255 characters. Example: <code>Ross</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>last_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="last_name"                data-endpoint="POSTapi-persons"
               value="Geller"
               data-component="body">
    <br>
<p>The last name of the person. Max 255 characters. Example: <code>Geller</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>middle_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="middle_name"                data-endpoint="POSTapi-persons"
               value="Gary"
               data-component="body">
    <br>
<p>The middle name of the person. Max 255 characters. Example: <code>Gary</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>nickname</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="nickname"                data-endpoint="POSTapi-persons"
               value="Bear"
               data-component="body">
    <br>
<p>The nickname of the person. Max 255 characters. Example: <code>Bear</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>maiden_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="maiden_name"                data-endpoint="POSTapi-persons"
               value="Johnson"
               data-component="body">
    <br>
<p>The maiden name of the person, important in some cultures, where a woman’s surname changes after marriage. Max 255 characters. Example: <code>Johnson</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>prefix</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="prefix"                data-endpoint="POSTapi-persons"
               value="Mr."
               data-component="body">
    <br>
<p>The prefix of the person. Max 255 characters. Example: <code>Mr.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>suffix</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="suffix"                data-endpoint="POSTapi-persons"
               value="Jr."
               data-component="body">
    <br>
<p>The suffix of the person. Max 255 characters. Example: <code>Jr.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>can_be_deleted</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
<i>optional</i> &nbsp;
            ...
            <input type="radio" name="can_be_deleted"
                   value="true"
                   data-endpoint="POSTapi-persons"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="POSTapi-persons" style="display: none">
    ...
    <br>
<p>Whether the person can be deleted. 0 for false, 1 for true. Example: <code>true</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>is_listed</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
<i>optional</i> &nbsp;
                <label data-endpoint="POSTapi-persons" style="display: none">
            <input type="radio" name="is_listed"
                   value="true"
                   data-endpoint="POSTapi-persons"
                   data-component="body"             >
            <code>true</code>
    ...
    <br>
<p>Whether the person should be listed in the person list. 0 for false, 1 for true. Example: <code>true</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://peopleos.test/api/persons/qui" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://peopleos.test/api/persons/qui"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/qui';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-GETapi-persons--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-persons--id-"></span>:
    </blockquote>
...
<form id="form-GETapi-persons--id-" data-method="GET"
      data-path="api/persons/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-persons--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-persons--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-persons--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-persons--id-"
               value="qui"
               data-component="url">
    <br>
<p>The ID of the person. Example: <code>qui</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>person</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person"                data-endpoint="GETapi-persons--id-"
               value="1"
               data-component="url">
    <br>
<p>The id of the person. Example: <code>1</code></p>
...
<p>Once updated, the person will be returned in the response, as well as
the display name of the person. This name's format depends on the user
settings.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "https://peopleos.test/api/persons/expedita" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"gender_id\": 1,
    ...
    \"nickname\": \"Mike\",
    \"maiden_name\": \"Johnson\",
    \"patronymic_name\": \"iejqlofbfpexcdypattj\",
    \"tribal_name\": \"vtzhbrtswipviomiwzkuc\",
    \"prefix\": \"Mr.\",
    \"suffix\": \"Jr.\",
    \"can_be_deleted\": true,
    \"is_listed\": true
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/expedita';
$response = $client-&gt;put(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-PUTapi-persons--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-persons--id-"></span>:
    </blockquote>
...
<form id="form-PUTapi-persons--id-" data-method="PUT"
      data-path="api/persons/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-persons--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-persons--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-persons--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-persons--id-"
               value="expedita"
               data-component="url">
    <br>
<p>The ID of the person. Example: <code>expedita</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>person</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person"                data-endpoint="PUTapi-persons--id-"
               value="1"
               data-component="url">
    <br>
<p>The id of the person. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="gender_id"                data-endpoint="PUTapi-persons--id-"
               value="1"
               data-component="body">
    <br>
<p>The gender associated with the person. This object must be a valid Gender object. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>first_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="first_name"                data-endpoint="PUTapi-persons--id-"
               value="Michael"
               data-component="body">
    <br>
<p>The first name of the person. Max 255 characters. Example: <code>Michael</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>last_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="last_name"                data-endpoint="PUTapi-persons--id-"
               value="Scott"
               data-component="body">
    <br>
<p>The last name of the person. Max 255 characters. Example: <code>Scott</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>middle_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="middle_name"                data-endpoint="PUTapi-persons--id-"
               value="Gary"
               data-component="body">
    <br>
<p>The middle name of the person. Max 255 characters. Example: <code>Gary</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="nickname"                data-endpoint="PUTapi-persons--id-"
               value="Mike"
               data-component="body">
    <br>
<p>The nickname of the person. Max 255 characters. Example: <code>Mike</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>maiden_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="maiden_name"                data-endpoint="PUTapi-persons--id-"
               value="Johnson"
               data-component="body">
    <br>
<p>The maiden name of the person, important in some cultures, where a woman’s surname changes after marriage. Max 255 characters. Example: <code>Johnson</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="patronymic_name"                data-endpoint="PUTapi-persons--id-"
               value="iejqlofbfpexcdypattj"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>iejqlofbfpexcdypattj</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="tribal_name"                data-endpoint="PUTapi-persons--id-"
               value="vtzhbrtswipviomiwzkuc"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vtzhbrtswipviomiwzkuc</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>prefix</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="prefix"                data-endpoint="PUTapi-persons--id-"
               value="Mr."
               data-component="body">
    <br>
<p>The prefix of the person. Max 255 characters. Example: <code>Mr.</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="suffix"                data-endpoint="PUTapi-persons--id-"
               value="Jr."
               data-component="body">
    <br>
<p>The suffix of the person. Max 255 characters. Example: <code>Jr.</code></p>
...
<i>optional</i> &nbsp;
            ...
            <input type="radio" name="can_be_deleted"
                   value="true"
                   data-endpoint="PUTapi-persons--id-"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="PUTapi-persons--id-" style="display: none">
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request DELETE \
    "https://peopleos.test/api/persons/autem" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/autem';
$response = $client-&gt;delete(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-DELETEapi-persons--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-persons--id-"></span>:
    </blockquote>
...
<form id="form-DELETEapi-persons--id-" data-method="DELETE"
      data-path="api/persons/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-persons--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-persons--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-persons--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-persons--id-"
               value="autem"
               data-component="url">
    <br>
<p>The ID of the person. Example: <code>autem</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>person</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person"                data-endpoint="DELETEapi-persons--id-"
               value="1"
               data-component="url">
    <br>
<p>The id of the person. Example: <code>1</code></p>
...
<p>This API call returns a paginated collection of work history entries that contains
15 items per page.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://peopleos.test/api/persons/atque/work-history" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://peopleos.test/api/persons/atque/work-history"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/atque/work-history';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-GETapi-persons--person_id--work-history" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-persons--person_id--work-history"></span>:
    </blockquote>
...
<form id="form-GETapi-persons--person_id--work-history" data-method="GET"
      data-path="api/persons/{person_id}/work-history"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-persons--person_id--work-history', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-persons--person_id--work-history"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-persons--person_id--work-history"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person_id"                data-endpoint="GETapi-persons--person_id--work-history"
               value="atque"
               data-component="url">
    <br>
<p>The ID of the person. Example: <code>atque</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>person</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person"                data-endpoint="GETapi-persons--person_id--work-history"
               value="1"
               data-component="url">
    <br>
<p>The id of the person. Example: <code>1</code></p>
...
<span id="execution-results-POSTapi-persons--person--work-history" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-persons--person--work-history"></span>:
    </blockquote>
...
<form id="form-POSTapi-persons--person--work-history" data-method="POST"
      data-path="api/persons/{person}/work-history"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-persons--person--work-history', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-persons--person--work-history"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-persons--person--work-history"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person"                data-endpoint="POSTapi-persons--person--work-history"
               value="1"
               data-component="url">
    <br>
<p>The id of the person. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="company_name"                data-endpoint="POSTapi-persons--person--work-history"
               value="Google"
               data-component="body">
    <br>
<p>The name of the company. Example: <code>Google</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>job_title</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="job_title"                data-endpoint="POSTapi-persons--person--work-history"
               value="Software Engineer"
               data-component="body">
    <br>
<p>The job title. Example: <code>Software Engineer</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>estimated_salary</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="estimated_salary"                data-endpoint="POSTapi-persons--person--work-history"
               value="$100,000"
               data-component="body">
    <br>
<p>The estimated salary. Example: <code>$100,000</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>active</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
 &nbsp;
            ...
            <input type="radio" name="active"
                   value="true"
                   data-endpoint="POSTapi-persons--person--work-history"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="POSTapi-persons--person--work-history" style="display: none">
    ...
    <br>
<p>Whether the work history entry is active. Example: <code>true</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>duration</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="duration"                data-endpoint="POSTapi-persons--person--work-history"
               value="1 year"
               data-component="body">
    <br>
<p>The duration of the work history entry. Example: <code>1 year</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://peopleos.test/api/persons/blanditiis/work-history/iure" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://peopleos.test/api/persons/blanditiis/work-history/iure"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/blanditiis/work-history/iure';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-GETapi-persons--person_id--work-history--entry-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-persons--person_id--work-history--entry-"></span>:
    </blockquote>
...
<form id="form-GETapi-persons--person_id--work-history--entry-" data-method="GET"
      data-path="api/persons/{person_id}/work-history/{entry}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-persons--person_id--work-history--entry-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-persons--person_id--work-history--entry-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-persons--person_id--work-history--entry-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person_id"                data-endpoint="GETapi-persons--person_id--work-history--entry-"
               value="blanditiis"
               data-component="url">
    <br>
<p>The ID of the person. Example: <code>blanditiis</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="entry"                data-endpoint="GETapi-persons--person_id--work-history--entry-"
               value="iure"
               data-component="url">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person"                data-endpoint="GETapi-persons--person_id--work-history--entry-"
               value="1"
               data-component="url">
    <br>
<p>The id of the person. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="work_history"                data-endpoint="GETapi-persons--person_id--work-history--entry-"
               value="1"
               data-component="url">
    <br>
<p>The id of the work history entry. Example: <code>1</code></p>
            </div>
                    </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "https://peopleos.test/api/persons/qui/work-history/ut" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"company_name\": \"Google\",
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/qui/work-history/ut';
$response = $client-&gt;put(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-PUTapi-persons--person_id--work-history--entry-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-persons--person_id--work-history--entry-"></span>:
    </blockquote>
...
<form id="form-PUTapi-persons--person_id--work-history--entry-" data-method="PUT"
      data-path="api/persons/{person_id}/work-history/{entry}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-persons--person_id--work-history--entry-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-persons--person_id--work-history--entry-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-persons--person_id--work-history--entry-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person_id"                data-endpoint="PUTapi-persons--person_id--work-history--entry-"
               value="qui"
               data-component="url">
    <br>
<p>The ID of the person. Example: <code>qui</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="entry"                data-endpoint="PUTapi-persons--person_id--work-history--entry-"
               value="ut"
               data-component="url">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person"                data-endpoint="PUTapi-persons--person_id--work-history--entry-"
               value="1"
               data-component="url">
    <br>
<p>The id of the person. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="work_history"                data-endpoint="PUTapi-persons--person_id--work-history--entry-"
               value="1"
               data-component="url">
    <br>
<p>The id of the work history entry. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="company_name"                data-endpoint="PUTapi-persons--person_id--work-history--entry-"
               value="Google"
               data-component="body">
    <br>
<p>The name of the company. Example: <code>Google</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="job_title"                data-endpoint="PUTapi-persons--person_id--work-history--entry-"
               value="Software Engineer"
               data-component="body">
    <br>
<p>The job title. Example: <code>Software Engineer</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="estimated_salary"                data-endpoint="PUTapi-persons--person_id--work-history--entry-"
               value="$100,000"
               data-component="body">
    <br>
<p>The estimated salary. Example: <code>$100,000</code></p>
...
<small>boolean</small>&nbsp;
 &nbsp;
            ...
            <input type="radio" name="active"
                   value="true"
                   data-endpoint="PUTapi-persons--person_id--work-history--entry-"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="PUTapi-persons--person_id--work-history--entry-" style="display: none">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="duration"                data-endpoint="PUTapi-persons--person_id--work-history--entry-"
               value="1 year"
               data-component="body">
    <br>
<p>The duration of the work history entry. Example: <code>1 year</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request DELETE \
    "https://peopleos.test/api/persons/dolor/work-history/eaque" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/dolor/work-history/eaque';
$response = $client-&gt;delete(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-DELETEapi-persons--person_id--work-history--entry-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-persons--person_id--work-history--entry-"></span>:
    </blockquote>
...
<form id="form-DELETEapi-persons--person_id--work-history--entry-" data-method="DELETE"
      data-path="api/persons/{person_id}/work-history/{entry}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-persons--person_id--work-history--entry-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            </h3>
            <p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-persons--person_id--work-history--entry-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-persons--person_id--work-history--entry-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person_id"                data-endpoint="DELETEapi-persons--person_id--work-history--entry-"
               value="dolor"
               data-component="url">
    <br>
<p>The ID of the person. Example: <code>dolor</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>entry</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="entry"                data-endpoint="DELETEapi-persons--person_id--work-history--entry-"
               value="eaque"
               data-component="url">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="person"                data-endpoint="DELETEapi-persons--person_id--work-history--entry-"
               value="1"
               data-component="url">
    <br>
<p>The id of the person. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="work_history"                data-endpoint="DELETEapi-persons--person_id--work-history--entry-"
               value="1"
               data-component="url">
    <br>
<p>The id of the work history entry. Example: <code>1</code></p>
