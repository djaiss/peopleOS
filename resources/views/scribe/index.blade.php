...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-PUTapi-administration-marital-statuses--maritalStatus_id-" data-method="PUT" data-path="api/administration/marital-statuses/{maritalStatus_id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('PUTapi-administration-marital-statuses--maritalStatus_id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>integer</small>
            &nbsp; &nbsp;
            <input type="number" style="display: none" step="any" name="maritalStatus_id" data-endpoint="PUTapi-administration-marital-statuses--maritalStatus_id-" value="6" data-component="url" />
            <br />
            <p>
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <span id="example-requests-GETapi-persons--person_id--notes">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request GET \
    --get "https://peopleos.test/api/persons/nihil/notes" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
          ...
          <div class="javascript-example">
            <pre><code class="language-javascript">const url = new URL(
    "https://peopleos.test/api/persons/nihil/notes"
);
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/nihil/notes';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-GETapi-persons--person_id--notes" data-method="GET" data-path="api/persons/{person_id}/notes" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('GETapi-persons--person_id--notes', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="GETapi-persons--person_id--notes" value="nihil" data-component="url" />
            <br />
            <p>
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <span id="example-requests-GETapi-persons--person_id--notes--id-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request GET \
    --get "https://peopleos.test/api/persons/quod/notes/molestias" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
          ...
          <div class="javascript-example">
            <pre><code class="language-javascript">const url = new URL(
    "https://peopleos.test/api/persons/quod/notes/molestias"
);
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/quod/notes/molestias';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-GETapi-persons--person_id--notes--id-" data-method="GET" data-path="api/persons/{person_id}/notes/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('GETapi-persons--person_id--notes--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="GETapi-persons--person_id--notes--id-" value="quod" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>quod</code>
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="GETapi-persons--person_id--notes--id-" value="molestias" data-component="url" />
            <br />
            <p>
        ...
        <span id="example-requests-PUTapi-persons--person_id--notes--id-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request PUT \
    "https://peopleos.test/api/persons/atque/notes/cumque" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"content\": \"Ross is a good friend of mine.\"
...
fetch(url, {
    ...
    body: JSON.stringify(body),
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/atque/notes/cumque';
$response = $client-&gt;put(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-PUTapi-persons--person_id--notes--id-" data-method="PUT" data-path="api/persons/{person_id}/notes/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('PUTapi-persons--person_id--notes--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="PUTapi-persons--person_id--notes--id-" value="atque" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>atque</code>
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="PUTapi-persons--person_id--notes--id-" value="cumque" data-component="url" />
            <br />
            <p>
              The ID of the note. Example:
              <code>cumque</code>
        ...
        <span id="example-requests-DELETEapi-persons--person_id--notes--id-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request DELETE \
    "https://peopleos.test/api/persons/ipsam/notes/rerum" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/ipsam/notes/rerum';
$response = $client-&gt;delete(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-DELETEapi-persons--person_id--notes--id-" data-method="DELETE" data-path="api/persons/{person_id}/notes/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('DELETEapi-persons--person_id--notes--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="DELETEapi-persons--person_id--notes--id-" value="ipsam" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>ipsam</code>
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-GETapi-persons--id-" data-method="GET" data-path="api/persons/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('GETapi-persons--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="GETapi-persons--id-" value="qui" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>qui</code>
        ...
        <span id="example-requests-PUTapi-persons--id-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request PUT \
    "https://peopleos.test/api/persons/debitis" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"gender_id\": 1,
    ...
    \"nickname\": \"Mike\",
    \"maiden_name\": \"Johnson\",
    \"patronymic_name\": \"rrhmkqpcypbcehb\",
    \"tribal_name\": \"umoucyi\",
    \"prefix\": \"Mr.\",
    \"suffix\": \"Jr.\",
    \"can_be_deleted\": true,
...
fetch(url, {
    ...
    body: JSON.stringify(body),
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/debitis';
$response = $client-&gt;put(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-PUTapi-persons--id-" data-method="PUT" data-path="api/persons/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('PUTapi-persons--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="PUTapi-persons--id-" value="debitis" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>debitis</code>
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <i>optional</i>
            &nbsp;
            <input type="text" style="display: none" name="patronymic_name" data-endpoint="PUTapi-persons--id-" value="rrhmkqpcypbcehb" data-component="body" />
            <br />
            <p>
              Must not be greater than 255 characters. Example:
              <code>rrhmkqpcypbcehb</code>
            </p>
          </div>
          <div style="padding-left: 28px; clear: unset">
            ...
            <i>optional</i>
            &nbsp;
            <input type="text" style="display: none" name="tribal_name" data-endpoint="PUTapi-persons--id-" value="umoucyi" data-component="body" />
            <br />
            <p>
              Must not be greater than 255 characters. Example:
              <code>umoucyi</code>
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-DELETEapi-persons--id-" data-method="DELETE" data-path="api/persons/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('DELETEapi-persons--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="DELETEapi-persons--id-" value="eius" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>eius</code>
        ...
        <span id="example-requests-GETapi-persons--person_id--work-history">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request GET \
    --get "https://peopleos.test/api/persons/quia/work-history" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
          ...
          <div class="javascript-example">
            <pre><code class="language-javascript">const url = new URL(
    "https://peopleos.test/api/persons/quia/work-history"
);
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/quia/work-history';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-GETapi-persons--person_id--work-history" data-method="GET" data-path="api/persons/{person_id}/work-history" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('GETapi-persons--person_id--work-history', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="GETapi-persons--person_id--work-history" value="quia" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>quia</code>
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <span id="example-requests-GETapi-persons--person_id--work-history--entry-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request GET \
    --get "https://peopleos.test/api/persons/sit/work-history/ut" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
          ...
          <div class="javascript-example">
            <pre><code class="language-javascript">const url = new URL(
    "https://peopleos.test/api/persons/sit/work-history/ut"
);
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/sit/work-history/ut';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-GETapi-persons--person_id--work-history--entry-" data-method="GET" data-path="api/persons/{person_id}/work-history/{entry}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('GETapi-persons--person_id--work-history--entry-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="GETapi-persons--person_id--work-history--entry-" value="sit" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>sit</code>
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="entry" data-endpoint="GETapi-persons--person_id--work-history--entry-" value="ut" data-component="url" />
            <br />
            <p>
              Example:
              <code>ut</code>
        ...
        <span id="example-requests-PUTapi-persons--person_id--work-history--entry-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request PUT \
    "https://peopleos.test/api/persons/inventore/work-history/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"company_name\": \"Google\",
...
fetch(url, {
    ...
    body: JSON.stringify(body),
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/inventore/work-history/consequatur';
$response = $client-&gt;put(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-PUTapi-persons--person_id--work-history--entry-" data-method="PUT" data-path="api/persons/{person_id}/work-history/{entry}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('PUTapi-persons--person_id--work-history--entry-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="PUTapi-persons--person_id--work-history--entry-" value="inventore" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>inventore</code>
        ...
        <span id="example-requests-DELETEapi-persons--person_id--work-history--entry-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request DELETE \
    "https://peopleos.test/api/persons/dolores/work-history/nihil" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/persons/dolores/work-history/nihil';
$response = $client-&gt;delete(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-DELETEapi-persons--person_id--work-history--entry-" data-method="DELETE" data-path="api/persons/{person_id}/work-history/{entry}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('DELETEapi-persons--person_id--work-history--entry-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="person_id" data-endpoint="DELETEapi-persons--person_id--work-history--entry-" value="dolores" data-component="url" />
            <br />
            <p>
              The ID of the person. Example:
              <code>dolores</code>
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="entry" data-endpoint="DELETEapi-persons--person_id--work-history--entry-" value="nihil" data-component="url" />
            <br />
            <p>
              Example:
              <code>nihil</code>
