...
You can check the Dev Tools console for debugging information.</code></pre>
    ...
    \"nickname\": \"Mike\",
    \"maiden_name\": \"Johnson\",
    \"patronymic_name\": \"hkywiibbouvih\",
    \"tribal_name\": \"aayxsvkmsdcmfn\",
    \"prefix\": \"Mr.\",
    \"suffix\": \"Jr.\",
    \"can_be_deleted\": true
}"
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-PUTapi-persons--id-" data-method="PUT" data-path="api/persons/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('PUTapi-persons--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <i>optional</i>
            &nbsp;
            <input type="text" style="display: none" name="patronymic_name" data-endpoint="PUTapi-persons--id-" value="hkywiibbouvih" data-component="body" />
            <br />
            <p>
              Must not be greater than 255 characters. Example:
              <code>hkywiibbouvih</code>
            </p>
          </div>
          <div style="padding-left: 28px; clear: unset">
            ...
            <i>optional</i>
            &nbsp;
            <input type="text" style="display: none" name="tribal_name" data-endpoint="PUTapi-persons--id-" value="aayxsvkmsdcmfn" data-component="body" />
            <br />
            <p>
              Must not be greater than 255 characters. Example:
              <code>aayxsvkmsdcmfn</code>
            </p>
          </div>
          <div style="padding-left: 28px; clear: unset">
            <b style="line-height: 2"><code>prefix</code></b>
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <span id="example-requests-PUTapi-teams--id-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request PUT \
    "https://peopleos.test/api/teams/aut" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"Web developers\"
...
fetch(url, {
    ...
    body: JSON.stringify(body),
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/teams/aut';
$response = $client-&gt;put(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-PUTapi-teams--id-" data-method="PUT" data-path="api/teams/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('PUTapi-teams--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="PUTapi-teams--id-" value="aut" data-component="url" />
            <br />
            <p>
        ...
        <span id="example-requests-DELETEapi-teams--id-">
          ...
          <div class="bash-example">
            <pre><code class="language-bash">curl --request DELETE \
    "https://peopleos.test/api/teams/vel" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>
          </div>
...
fetch(url, {
    ...
    headers,
          ...
          <div class="php-example">
            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://peopleos.test/api/teams/vel';
$response = $client-&gt;delete(
    $url,
    [
        'headers' =&gt; [
...
You can check the Dev Tools console for debugging information.</code></pre>
        ...
        <form id="form-DELETEapi-teams--id-" data-method="DELETE" data-path="api/teams/{id}" data-authed="0" data-hasfiles="0" data-isarraybody="0" autocomplete="off" onsubmit="event.preventDefault(); executeTryOut('DELETEapi-teams--id-', this);">
          ...
          <div style="padding-left: 28px; clear: unset">
            ...
            <small>string</small>
            &nbsp; &nbsp;
            <input type="text" style="display: none" name="id" data-endpoint="DELETEapi-teams--id-" value="vel" data-component="url" />
            <br />
            <p>
              The ID of the team. Example:
              <code>vel</code>
