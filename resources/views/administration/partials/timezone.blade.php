...
<form action="{{ route('administration.update') }}" method="post" class="mb-8 border border-gray-200 bg-white sm:rounded-lg" x-data="{ showActions: false }">
  ...
  <!-- timezone -->
  <div class="grid grid-cols-3 items-center rounded-t-lg p-3 hover:bg-blue-50 last:rounded-b-lg">
    <x-input-label for="timezone" :value="__('Timezone')" class="col-span-1" />
    <div class="w-full justify-self-end col-span-2">
      <select @focus="showActions = true" @blur="showActions = false" id="timezone" name="timezone" class="mt-1 block w-full rounded-md border-gray-300 shadow-xs focus:border-indigo-500 focus:ring-indigo-500 disabled:text-gray-400 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-indigo-600 dark:focus:ring-indigo-600">
        ...
        <optgroup label="Africa">
            <option value="Africa/Casablanca">Western European Time (WET) - UTC+00:00</option>
            <option value="Africa/Lagos">West Africa Time (WAT) - UTC+01:00</option>
            <option value="Africa/Cairo">Eastern European Time (EET) - UTC+02:00</option>
            <option value="Africa/Johannesburg">South Africa Standard Time (SAST) - UTC+02:00</option>
        </optgroup>
        <optgroup label="America">
            <option value="America/St_Johns">Newfoundland Standard Time (NST) - UTC-03:30</option>
            <option value="America/Halifax">Atlantic Standard Time (AST) - UTC-04:00</option>
        ...
        <optgroup label="Antarctica">
            <option value="Antarctica/Palmer">Chile Summer Time (CLST) - UTC-03:00</option>
            <option value="Antarctica/McMurdo">New Zealand Standard Time (NZST) - UTC+12:00</option>
        </optgroup>
        <optgroup label="Asia">
            <option value="Asia/Dubai">Gulf Standard Time (GST) - UTC+04:00</option>
            <option value="Asia/Karachi">Pakistan Standard Time (PKT) - UTC+05:00</option>
            <option value="Asia/Kolkata">India Standard Time (IST) - UTC+05:30</option>
            <option value="Asia/Dhaka">Bangladesh Standard Time (BST) - UTC+06:00</option>
            <option value="Asia/Jakarta">Western Indonesia Time (WIB) - UTC+07:00</option>
            <option value="Asia/Shanghai">China Standard Time (CST) - UTC+08:00</option>
            <option value="Asia/Tokyo">Japan Standard Time (JST) - UTC+09:00</option>
            <option value="Asia/Seoul">Korea Standard Time (KST) - UTC+09:00</option>
        </optgroup>
        <optgroup label="Australia">
            <option value="Australia/Perth">Australian Western Standard Time (AWST) - UTC+08:00</option>
            <option value="Australia/Adelaide">Australian Central Standard Time (ACST) - UTC+09:30</option>
        ...
        <optgroup label="Europe">
            ...
            <option value="Europe/Berlin">Central European Time (CET) - UTC+01:00</option>
            <option value="Europe/Moscow">Moscow Standard Time (MSK) - UTC+03:00</option>
        </optgroup>
        <optgroup label="Pacific">
            <option value="Pacific/Auckland">New Zealand Standard Time (NZST) - UTC+12:00</option>
            <option value="Pacific/Fiji">Fiji Time (FJT) - UTC+12:00</option>
        </optgroup>
    </select>
