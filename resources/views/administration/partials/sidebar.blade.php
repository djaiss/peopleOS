    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="flex flex-col gap-0.5">
        ...
        @if (config('peopleos.show_marketing_site'))
          <a href="{{ route('administration.marketing.index') }}">
            <div class="{{ request()->routeIs('administration.marketing.index') ? 'text-green-600 hover:bg-green-600/5 dark:text-green-500 dark:hover:bg-green-500/5' : 'text-zinc-600 hover:bg-zinc-950/5 hover:text-zinc-800 dark:text-zinc-400' }} flex h-8 items-center justify-between gap-3 rounded-lg px-2 text-sm leading-5 dark:hover:bg-white/5 dark:hover:text-white">
              <div class="flex items-center gap-2">
      ...
      <div class="flex flex-col gap-0.5">
        ...
        <a href="{{ route('administration.export.index') }}">
          <div class="{{ request()->routeIs('administration.export.index') ? 'text-green-600 hover:bg-green-600/5 dark:text-green-500 dark:hover:bg-green-500/5' : 'text-zinc-600 hover:bg-zinc-950/5 hover:text-zinc-800 dark:text-zinc-400 dark:hover:bg-white/5 dark:hover:text-white' }} flex h-8 items-center justify-between gap-3 rounded-lg px-2 text-sm leading-5">
            <div class="flex items-center gap-2">
              <x-lucide-download class="size-4 min-w-3" />
              <span>
                {{ __('Export Data') }}
              </span>
            </div>
