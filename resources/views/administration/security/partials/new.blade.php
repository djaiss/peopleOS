<form id="add-api-key-form" x-target="api-key-list add-api-key-form api-key-notification notifications" x-target.back="add-api-key-form" action="{{ route('administration.security.create') }}" method="POST" class="space-y-5 border-b border-gray-200 p-4 hover:bg-blue-50">
  @csrf
