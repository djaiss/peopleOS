<x-marketing-handbook-layout>
  <x-slot name="breadcrumb">
    ...
    <span class="text-gray-500">&gt;</span>
    <a href="{{ route('marketing.handbook.index') }}" class="text-blue-500 hover:underline">{{ __('Handbook') }}</a>
    <span class="text-gray-500">&gt;</span>
  ...
  <div class="prose">
    ...
    <p class="mb-2">My passion, when I get back from my real work (the one that pays the bills), is to code and learn new things every day. This is how I relieve my stress from a challenging day job (which is not about code at all). So even though I stopped working on Monica, I still wanted to code every day.
    </p>
