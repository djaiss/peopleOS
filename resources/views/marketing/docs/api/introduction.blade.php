<x-marketing-docs-layout>
  ...
  <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 mb-10 border-b border-gray-200 pb-10">
    <div>
  ...
  <div class="mb-10 border-b border-gray-200 pb-10 sm:grid-cols-2">
    ...
    <p class="mb-2">If you want to test the API yourself, we provide a <a href="https://yaak.app/" target="_blank" class="text-blue-500 hover:underline">Yaak collection</a> for you to use, as a workspace.</p>
    <p class="mb-2">The documentation is included in the Github repository, under the <a href="https://github.com/djaiss/peopleOS/tree/main/docs/yaak" target="_blank" class="text-blue-500 hover:underline">docs/yaak</a> folder.</p>
