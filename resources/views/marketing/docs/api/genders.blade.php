...
{{-- @llms-title: Genders --}}
{{-- @llms-description: Learn how to manage genders --}}
{{-- @llms-route: /docs/api/genders --}}
<x-marketing-docs-layout :marketing-page="$marketingPage" :view-name="$viewName">
  ...
  <div class="mb-8 rounded-lg border p-4">
    ...
    <ul>
      ...
      <li>
        <a href="#show-a-gender" class="text-blue-500 hover:underline">Show a gender</a>
      </li>
      <li>
  ...
  <div class="mb-10 grid grid-cols-1 gap-6 border-b border-gray-200 pb-10 sm:grid-cols-2">
    <div>
      <h3 id="show-a-gender" class="mb-2 text-lg font-bold">Show a gender</h3>
      <p class="mb-10">This endpoint shows a gender.</p>

      <!-- url parameters -->
      <x-marketing.url-parameters>
        <x-marketing.attribute required name="id" type="integer" description="The ID of the gender to show." />
      </x-marketing.url-parameters>
