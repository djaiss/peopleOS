        ...
        <div x-data="{
          ...
          <div x-show="openApiDocumentation" class="mb-10 ml-3">
            ...
            <div x-show="personsDocumentation" class="flex flex-col gap-y-2">
              ...
              <div>
                <a href="{{ route('marketing.docs.api.tasks') }}" class="{{ request()->routeIs('marketing.docs.api.tasks') ? 'border-l-blue-400' : 'border-l-transparent' }} border-l-3 pl-3 hover:border-l-blue-400 hover:underline">{{ __('Tasks') }}</a>
              </div>
            </div>
          </div>
        </div>
