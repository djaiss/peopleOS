<div class="fixed top-0 z-10 w-full">
  ...
  <nav class="max-w-8xl mx-auto flex h-10 items-center justify-between border-b bg-gray-50 px-3 sm:px-6 dark:border-slate-600 dark:bg-gray-800 dark:text-slate-200">
    <div class="dark:highlight-white/5 items-center rounded-lg border border-gray-200 bg-white px-2 py-1 text-sm sm:flex dark:border-0 dark:border-gray-700 dark:bg-gray-400/20 dark:bg-gray-900">
      <x-link href="''" class="flex-shrink-0 dark:text-sky-400">Regis</x-link>
      ...
      <ul class="relative">
        ...
        <li class="me-4 inline">
          <x-link href="{{ route('settings.index') }}" class="relative inline">
            <svg xmlns="http://www.w3.org/2000/svg" class="relative -top-px me-1 inline-block h-4 w-4 cursor-pointer text-gray-600 sm:h-4 sm:w-4 dark:text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <li class="inline">
          <x-link class="inline" href="{{ route('logout') }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="me-1 inline-block h-4 w-4 cursor-pointer text-gray-600 sm:h-4 sm:w-4 dark:text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
