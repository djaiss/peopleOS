<x-marketing-layout>
  <div class="border-b border-gray-200 py-3 text-sm">
    <div class="mx-auto flex max-w-7xl items-center gap-x-4 px-6 lg:px-0">
      <div class="flex flex-col items-center justify-center gap-y-1 group cursor-pointer gap-x-2 rounded-sm border border-b-3 border-transparent px-2 py-1 transition-colors duration-150 hover:border-gray-400 hover:bg-white">
  ...
  <div class="relative mx-auto max-w-7xl px-6 lg:px-8 xl:px-0">
    <div class="grid grid-cols-1 gap-x-16 lg:grid-cols-[300px_1fr_150px]">
      <!-- Sidebar -->
      <div class="hidden w-full flex-shrink-0 flex-col justify-self-end sm:border-r sm:border-gray-200 sm:pr-3 lg:flex">
        <div x-data="{
          ...
          <div class="mb-2 flex items-center justify-between rounded-md px-2 py-1">
            <a href="{{ route('marketing.handbook.index') }}" class="hover:underline">{{ __('Table of contents') }}</a>
          </div>
          ...
          <div x-show="openApiDocumentation" class="mb-10 ml-3">
            <div class="mb-3 flex flex-col gap-y-2">
              <div>
                <a href="{{ route('marketing.handbook.project') }}" class="{{ request()->routeIs('marketing.handbook.project') ? 'border-l-blue-400' : 'border-l-transparent' }} border-l-3 pl-3 hover:border-l-blue-400 hover:underline">{{ __('Who I am and what is this project') }}</a>
              </div>
              <div>
      ...
      <!-- Sidebar -->
      <div class="hidden w-full flex-shrink-0 flex-col justify-self-end sm:border-l sm:border-gray-200 sm:pl-3 lg:flex">
