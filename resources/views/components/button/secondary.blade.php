...
@else
  <button {{ $attributes->merge(['type' => 'submit', 'class' => 'button dark:box-s relative border-zinc-900 bg-white dark:border-zinc-100 dark:bg-gray-800 dark:text-gray-100']) }}>
    {{ $slot }}
  </button>
@endif
